...
//		gender = scanner.next();
	...
	public void setHoewonDelete() {
		// 회원 삭제
		System.out.print("삭제할 회원번로를 입력하세요? ");
		int idx = scanner.nextInt();
	...
	public void getHoewonList() {
		...
		for (int i = 0; i < vos.size(); i++) {
			System.out.print(vos.get(i).getIdx() + "\t" + vos.get(i).getName() + "\t" + vos.get(i).getAge() + "\t"
					+ vos.get(i).getGender() + "\t" + vos.get(i).getAddress() + "\n");
		}
		lineMethod(line);
	}
